    ...
    topics: [
      {
        ...
        steps: [
          ...
          'Crie planos de benefício (desconto, pague X leve Y) e use-os ao contratar pacotes',
          'Em “Criar pacote mensal”, escolha Mês único ou Período (1, 3, 6, 9 ou 12 meses)',
          'No período, informe o mês inicial e a duração; o sistema gera um pacote por mês com relatório de sucesso/falha',
          'Acompanhe status de pagamento e vigência na lista de pacotes recentes',
        ],
        tips: [
          'Se o menu não aparecer, o recurso pode estar desligado no plano ou nas configurações',
          'Geração em lote usa apenas pagamento no balcão; Mercado Pago permanece no mês único',
          'Antes de gerar, a pré-visualização mostra quais meses serão criados e quais já existem',
          'Após gerar em lote, use “Filtrar por lote” na lista para ver só os pacotes daquela operação',
          'Com um lote selecionado: “Cancelar lote inteiro” ou “Complementar meses faltantes”',
          'Período com Mercado Pago: cada mês terá checkout separado; use a lista de checkouts pendentes do lote',
          'O valor é recalculado em cada mês; conflitos de horário aparecem no relatório sem cancelar os demais',
        ],
