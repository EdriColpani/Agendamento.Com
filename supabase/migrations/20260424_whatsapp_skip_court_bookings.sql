-- WhatsApp: ignora agendamentos de quadra (booking_kind = 'court') no pipeline de mensagens.
-- Mantém comportamento atual para agendamentos de serviço.
...
'Agenda mensagens WhatsApp apenas para booking_kind=service; booking_kind=court é ignorado por regra.';
