-- Reserva pública de quadra: permite informar método de pagamento no momento da confirmação.
-- Compatível com chamadas antigas (sem p_payment_method) via wrapper.
...
BEGIN
  ...
  IF v_payment_method IS NOT NULL
     AND v_payment_method NOT IN ('dinheiro', 'cartao_credito', 'cartao_debito', 'pix') THEN
